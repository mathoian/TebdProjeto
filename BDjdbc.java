...
//teste
	...
	/**
	 * M�todo responsavel por fazer a conexao com o Banco atraves de um driver JDBC
	 * e do objeto conn.
	 *
	 * @throws Exception Contendo a descri��o do erro que poder� vir acontecer se
	...
	public void setConexao() throws Exception {
		try {
			 ...
			 * 
			 * Class.forName (DriverUtilities.getDriver(DriverUtilities.MSSQL)); String url
			 * = this.dataSource; System.out.println(url);
			...
			String url = "jdbc:mariadb://localhost:3306/dbateste";
	 ...
	 *
	 * @return Connection Objeto que encapsula metodos para conexao com o Banco de
	 *         Dados.
	 */
	...
	public static void main(String args[]) throws Exception {
		...
		try {
			...
			String url = "jdbc:mariadb://127.0.0.1:3306/db_tebd";// for win: String url =
																	// "jdbc:mysql://127.0.0.1:3306/db_tebd";
